...
public class SearchResult {
	...
	public String getSanitizedContentHeader(){return StringUtil.generateConcatenatedLongString(this.contentHeader, 50);}
	...
	private String keywordHighlight;
	public String getKeywordHighlight() {return keywordHighlight;}
	public void setKeywordHighlight(String keywordHighlight) {this.keywordHighlight = keywordHighlight;}
